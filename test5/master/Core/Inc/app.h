...
/* 跟随增益取 0.5（1:2）而不是 1:1：
   舵机指令被限幅在 25°~155°（±65°，余量是为了不顶机械限位），
   若 1:1 映射，面包板只要转 65° 就顶死、表现为"云台卡在一边不动"。
   0.5 增益后手上可转 ±130°，且舵机所需转速减半（SG90 扭矩有限，更跟得上）。 */
#define APP_GYRO_PAN_GAIN       0.5f    /* 水平跟随比例 */
#define APP_GYRO_TILT_GAIN      0.5f    /* 俯仰跟随比例 */
